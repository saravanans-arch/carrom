...
var HitSfx = new Audio('/sounds/Hit.wav');
var PocketSfx = new Audio('/sounds/Pocket.wav');
var AmbienceSfx = new Audio('/sounds/Ambience.wav');
HitSfx.preload = 'auto';
...
var main=function() {
  ...
  var cmaterial = new THREE.MeshBasicMaterial( {color: 0xDADFE1} );
  var uppowercube = new THREE.Mesh( cgeometry, cmaterial );
  uppowercube.position.set(3,0,0);
  SCENE.add( uppowercube );
  var ccgeometry = new THREE.BoxGeometry( 0.3, 0.1, 0.1 );
  var ccmaterial = new THREE.MeshBasicMaterial( {color: 0xF9690E} );
  redBar = new THREE.Mesh( ccgeometry, ccmaterial );
